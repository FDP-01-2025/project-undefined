...
void showMenu()
{
    ...
    // Options
    string opt1 = "⪢ Empezar";
    string opt2 = "⪢ Historia";
    string opt3 = "Empezar [Press Enter]       Historia [Press h]";
    ...
    moveCursor(x + (boxWidth - opt3.size()) / 2, currentY + 2);
...
/*     moveCursor(x + (boxWidth - opt4.size()) / 2, currentY++);
    ...
    moveCursor(x + (boxWidth - opt5.size()) / 2, currentY + 4);

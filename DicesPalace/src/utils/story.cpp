...
bool showStory() {
    ...
    string story[] = {
        ...
        "a un castillo en plena época medieval, rodeado de laberintos de piedra, oscuridad y magia.",
        "",
        "Sin pistas de dónde está ni cómo llegó, comienza su búsqueda por sobrevivir y escapar.",
        "En lo profundo del castillo, le esperan decisiones, laberintos inciertos y enemigos ocultos.",
        "",
        "Criaturas pixeladas, jefes enigmáticos, mini juegos...",
